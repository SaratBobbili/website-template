...
export default function ProjectsList() {
    const projects: ProjectCardProps[] = [
        ...
        {
            title: "PyDetectGPT",
            description: "An easy to use python package for detecting ai generated text",
            image: pydetectgpt,
    ...
    return (
        <section className="section-container">
            ...
            <p className="text-center md:text-left font-inter italic my-2 lg:my-4">All thumbnails generated with <a className="underline" href="https://huggingface.co/black-forest-labs/FLUX.1-dev" target="_blank">FLUX.1-dev</a>*</p>
